...
- `vaah flutter:install` or `npx vaah cms:install` : It will install VaahFlutter in newly created `vaahflutter` folder
- `vaah flutter:install [FOLDER]` : To install VaahFlutter
- `vaah flutter:install --here` : To install VaahFlutter in current director
...
vaah/2.1.14 win32-x64 node-v16.15.0
$ vaah --help [COMMAND]
USAGE
  $ vaah COMMAND
...
...
_See code: [src/commands/cms/auth.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/auth.ts)_
...
_See code: [src/commands/cms/crud.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/crud.ts)_
...
_See code: [src/commands/cms/install.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/install.ts)_
...
_See code: [src/commands/cms/m.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/m.ts)_
...
_See code: [src/commands/cms/m-crud.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/m-crud.ts)_
...
_See code: [src/commands/cms/m-make.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/m-make.ts)_
...
_See code: [src/commands/cms/settings.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/settings.ts)_
...
_See code: [src/commands/cms/t.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/t.ts)_
...
_See code: [src/commands/cms/t-make.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/t-make.ts)_
...
_See code: [src/commands/cms/taxonomies.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/taxonomies.ts)_
...
_See code: [src/commands/cms/users.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/cms/users.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/webreinvent/vaah/blob/v2.1.14/src/commands/hello.ts)_
