...
export default class CmsCrud extends Command {
  ...
  successMessage()
  {
    ...
    this.log(n+++") Add seeder code in <module>/Database/Seeds/DatabaseTableSeeder.php file");
    ...
    {
      this.log(n+++") Add vue router link of General Setting to your <module>/Vue/Components/Aside.vue file");
    }
